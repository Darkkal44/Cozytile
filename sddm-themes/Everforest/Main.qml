        ...
        Column {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    radius: 8
                    border.color: name.activeFocus ? "#D3C6AA" : "transparent"
                    border.width: 1
            ...
            Column {
                ...
                Rectangle {
                    ...
                    color: Qt.rgba(255, 255, 255, 0.05)
                    radius: 8
                    border.color: password.activeFocus ? "#D3C6AA" : "transparent"
                    border.width: 1
            ...
            Rectangle {
                ...
                width: parent.width
                height: 44
                color: loginMouseArea.pressed ? "#B3A68A" : (loginMouseArea.containsMouse ? "#E3D6BA" : "#D3C6AA")
                radius: 8
            ...
            Item {
                ...
                Rectangle {
                    ...
                    border.color: sessionSelectorMouse.containsMouse || sessionList.visible ? "#D3C6AA" : Qt.rgba(255,255,255,0.15)
                    border.width: 1
            ...
            Row {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        anchors.fill: parent
                        radius: 8
                        color: shutdownMouse.pressed ? "#B3A68A" : (shutdownMouse.containsMouse ? "#E3D6BA" : "#D3C6AA")
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        anchors.fill: parent
                        radius: 8
                        color: rebootMouse.pressed ? "#B3A68A" : (rebootMouse.containsMouse ? "#E3D6BA" : "#D3C6AA")
