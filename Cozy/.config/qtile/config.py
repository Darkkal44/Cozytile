...
# C U S T O M
    ...
    #Key([mod], "t",lazy.spawn("xrandr --output eDP --auto"),lazy.spawn("sh -c 'sleep 0.5 && xrandr --output eDP --scale-from 1920x1080'"),desc='nothing'),
    #Key([mod], "w", lazy.spawn("xrandr --output eDP --off"), desc='nothing'),
